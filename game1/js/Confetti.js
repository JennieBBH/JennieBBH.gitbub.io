...
var Confetti = function () {
  function Confetti(param) {
    ...
    this.canvas.style.cssText = ["display: block", "position: absolute", "top: 0", "left: 0", "pointer-events: none", "z-index: 2020"].join(";");
  ...
  /*Confetti.prototype.clear = function clear() {
...
function ConfettiStart() {
  console.log("ConfettiStart");
  var DURATION = 8000,
      LENGTH = 120;

  confetti_canvas = new Confetti({
